        ...
        information: [
            ...
            },
            {
                ...
                options: [
                    ...
                    'three thousand pesos (₱3,000)', 
                    'four thousand pesos (₱4,000)', 
                    'five thousand pesos (₱5,000)',
                    'six thousand pesos (₱6,000)',
                    'seven thousand pesos (₱7,000)',
                    'eight thousand pesos (₱8,000)',
                    'nine thousand pesos (₱9,000)',
    ...
    { 
        ...
        information: [
            ...
            },
            {
                label: 'Purpose',
                type: 'select',
                options: ['Employment', 'Loan', 'MTOP', 'Postal ID'],
                required: true,
                placeholder: 'Select a purpose',
            },
            {
